<?php
// filepath: /Applications/XAMPP/xamppfiles/htdocs/dvlaregister/src/views/user/view-certificate.php
session_start();
...
try {
    // Authentication and data fetching similar to download-certificate-pdf.php
    ...
    if (!$user) {
        ...
        try {
            ...
            // Ignore error and continue with default Ghana Card
        }
        ...
        try {
            ...
            // Ignore error and continue without vehicle_use
        }
        ...
        if (!$vehicleDetails) {
            $errors[] = "Vehicle not found or you don't have permission to view it";
        } else {
            ...
            // Set vehicle_use if it doesn't exist or is empty
...
<body>
    <div class="container mt-4 no-print">
        <div class="alert alert-primary">
            <i class="fas fa-info-circle me-2"></i> Vehicle Registration Certificate
            <span class="float-end">
                <a href="vehicle-details.php?id=<?= $vehicleId ?>" class="btn btn-sm btn-outline-primary">
        ...
        <?php if (!empty($errors)): ?>
            ...
            <a href="my-vehicles.php" class="btn btn-secondary">Back to My Vehicles</a>
        <?php endif; ?>
        ...
        <?php if ($vehicleDetails): ?>
            <div class="print-buttons no-print">
                ...
                <a href="vehicle-details.php?id=<?= $vehicleId ?>" class="btn btn-secondary">
                            ...
                            <div class="col-md-6">
                                <div class="info-row">
                                    ...
                                    <div class="info-item">
                                        ...
                                        <div class="info-value"><?= htmlspecialchars($vehicleDetails['vehicle_type']) ?></div>
                                    </div>
                                </div>
                                <div class="info-row">
                                    <div class="info-item">
